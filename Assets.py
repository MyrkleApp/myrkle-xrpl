...
from xrpl.models import (AccountSet, AccountSetFlag, IssuedCurrencyAmount,
                         ...
                         TrustSet, Transaction, AccountSetAsfFlag, TrustSetFlag)
...
def accountset_manager(manager_addr: str, domain: str, fee: str = None) -> dict:
    txn = AccountSet(account=manager_addr,set_flag=AccountSetAsfFlag.ASF_REQUIRE_AUTH,domain=validate_symbol_to_hex(domain), fee=fee, memos=mm(), source_tag=M_SOURCE_TAG)
    return txn.to_xrpl()
...
{
    "issuer_addr": "rGiyqjWjhsRZ8FUjBL2k5ciUa2tcptTX9W",
    "manager_addr": "rqga9EVfFAj2HJMwmFVccDS6zgXrRgh9j",
    "token_name": "test token for sammy1",
    "total_supply": "22439473523"
}
print(create_trustline(
